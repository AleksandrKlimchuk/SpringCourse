...
import simulator.annotations.JsonObjectToReport;
...
public interface ToReportSerializer {
    ...
    static private String convertObjectToJson(Object object, int nesting) throws Exception {
        ...
        for (Field field : c.getDeclaredFields()) {
            ...
            if (field.isAnnotationPresent(JsonObjectToReport.class)) {
                builder.append(convertObjectToJson(field.get(object), nesting + 1));
            }
            else if (field.isAnnotationPresent(JsonPrimitiveToReport.class)) {
    ...
    private static void checkIfSerializable(Object object) throws Exception {
        ...
        Class c = object.getClass();
        if (!c.isAnnotationPresent(ReportSerializable.class)) {
