package simulator.deserializer;

import timetable_generator.Types.PortEntity;
import simulator.annotations.DeserializeConstructor;
...
public interface JsonDeserializer {
    ...
    public static List<PortEntity> deserializeFromString(String JSONString) throws IllegalAccessException,
            InvocationTargetException, InstantiationException {
