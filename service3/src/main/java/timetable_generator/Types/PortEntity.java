...
public class PortEntity {
    ...
    public void setPortEntityForReport() {
        /*@JsonObjectToReport
        private Date realArriveDate = new Date();
        @JsonObjectToReport
        private Time unloadingDelay = new Time();
        ...
        realArriveDate = new Date(realArriveDateMinute);
        unloadingDelay = new Time(unloadingStartDateInMinutes - realArriveDateMinute);
        unloadingStartDate = new Date(unloadingStartDateInMinutes);
        unloadingTime = new Time(unloadingEndDateInMinutes - unloadingStartDateInMinutes);
    }
